...
export function CreateAdModal() {
    ...
    async function handleCreateAd(event: FormEvent) {
        ...
        const formData = new FormData(event.target as HTMLFormElement) //enviando ao td q o target é formulario
    ...
    return (
        <Dialog.Portal>
            ...
            <form onSubmit={handleCreateAd} action="" className='mt-8 flex flex-col gap-4'>
                ...
                <div className='flex flex-col gap-2'>
                    <label htmlFor="weesDays">Quando costuma jogar?</label>
                ...
                <div className='flex flex-col gap-2 flex-1'>
                    <label htmlFor="hourStart">Qual horário de dia?</label>
                ...
                <Dialog.Close //componente que ao clicar no cancelar fecha o modal
                    type='button'
